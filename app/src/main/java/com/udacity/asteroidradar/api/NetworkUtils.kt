...
fun parseImageOfTheDayJsonResult(jsonResult: JSONObject): PictureOfDay {
    val pictureOfTheDay = PictureOfDay(mediaType = jsonResult.getString("media_type"),
...
fun parseDtoAsteroidsJsonResult(jsonResult: JSONObject):NetworkAsteroidContainer {
    val nearEarthObjectsJson = jsonResult.getJSONObject("near_earth_objects")
    ...
    return NetworkAsteroidContainer(asteroidList.toList())
}
